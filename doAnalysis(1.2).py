...
with open('Vienna.csv', 'r', encoding='utf-8', newline='') as csvfile:
...
with open('negative(Vienna).csv', 'w') as csvfile:
  columns = ['arc_id','user_id', 'polarity', 'subjectivity','lang','TextBlob','lat','long'] 
...
with open('positive(Vienna).csv', 'w') as csvfile:
  columns = ['arc_id','user_id', 'polarity', 'subjectivity','lang','TextBlob','lat','long'] 
  writer = csv.DictWriter(csvfile, fieldnames=columns,extrasaction='ignore', delimiter = ';')
  writer.writeheader()
  #writer.writerows("\n\nTOP NEGATIVE TWEETS") 
...
with open('neutral(Vienna).csv', 'w') as csvfile:
  columns = ['arc_id','user_id', 'polarity', 'subjectivity','lang','TextBlob','lat','long'] 
  writer = csv.DictWriter(csvfile, fieldnames=columns,extrasaction='ignore', delimiter = ';')
  writer.writeheader()
  #writer.writerows("\n\nTOP NEGATIVE TWEETS") 
